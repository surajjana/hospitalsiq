...
<body id="page-top">
    ...
    <!--  <div class="slideout-menu">
        <a href="#" class="slideout-menu-toggle" style="position:absolute;top:0%;">&times;</a>
        <br/>
        <br/>
            <ul>
              <li><a href="#">Radiology<i class="fa fa-angle-right"></i></a></li>
              <li><a href="#">Ambulance <i class="fa fa-angle-right"></i></a></li>
              <li><a href="#">Emergency<i class="fa fa-angle-right"></i></a></li>
              <li><a href="#">ATM <i class="fa fa-angle-right"></i></a></li>
            ...
            <div class="row" id="top-bar">
                   <div class="col-md-1 col-lg-1 hidden-sm hidden-xs">
                    <div class="dropdown" >
                      ...
                      <button class="dropbtn" id="btt">  <i class="fa fa-bars" style="color:#fff;"></i> Filters
    ...
    <div class="row row-gap-small">
      ...
      <?php 
        ...
        echo '<div class="row row-gap-medium">
          ...
          <div class="col-sm-2"><center><img src="img/bb.png" id="pa" onload="fadeIn(this)" style="display:none;position:relative;top:1px;"/></center></div>

          
          <div class="col-sm-8" style="position:relative;left:3%" >
            ...
            <div class="row row-gap-small" >
              ...
              <div  class="row row-gap-small"> 
                <address>
                  '.$json_a["result"][$i]["address"].'<br/>'.$json_a["result"][$i]["category"].'<br/>'.$json_a["result"][$i]["type"].'<br/>
                </address>
